...
public abstract class FactionChangeMotdEvent extends FactionEvent {
     ...
     */
    @Cancelable
    public static class Pre extends FactionChangeMotdEvent implements IFactionPreEvent, IFactionEventDenyReason {
    ...
    public static class Post extends FactionChangeMotdEvent {
         ...
         * @param newMotd    The new MOTD of the faction
         */
        public Post(@NotNull final Faction faction, final String oldMotd, final String newMotd) {
            super(faction, newMotd);
